// calculamos la interseccion entre dos rectas
...
function calculateCollision(obj, direction, collideables, moveBy) {
  ...
  // calculamos el rectangulo de limites del objeto y comparamos con los colisionables
...
// calculamos la caja de colision
